...
## CI/CD (자동 빌드)
이 프로젝트는 GitHub Actions를 사용하여 데스크톱 앱을 자동으로 빌드하고 배포합니다.
- **트리거**: `v`로 시작하는 태그 푸시 시 (예: `v0.1.0`).
- **플랫폼**: Windows (`windows-latest`).
- **결과물**: MSI 및 EXE 설치 파일이 GitHub Release에 자동으로 첨부됩니다.
